...
Original file is located at
    https://colab.research.google.com/drive/1kow04OIiuq7trTt5xJFw1j3ummV78v2m
...
metrics_data = {
    'Classifier': ['KNN', 'Decision Tree', 'Random Forest', 'Logistic Regression', 'CamemBERT'],
    'Accuracy': [0.31, 0.31, 0.47, 0.45, 0.65],
    'F1 Score': [0.30, 0.32, 0.46, 0.44, 0.65],
    'Recall': [0.32, 0.33, 0.47, 0.45, 0.65],
    'Precision': [0.39, 0.32, 0.49, 0.44, 0.65]
}
...
for a, b, c in zip(y_test, y_pred, val_sentences):
  print(f"{c}: {a} and {b}")
